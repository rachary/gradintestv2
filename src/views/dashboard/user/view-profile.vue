...
<template>
  <div class="border-l border-gray-300 w-full h-full select-none flex flex-col">
    <div class="w-[100vw] xl:w-[34.25rem] py-3 px-4 flex justify-between items-center">
      <p class="text-2xl font-extrabold text-primary-3 dark:text-secondary-1">Profile</p>
    ...
    <div class="bg-primary-1 dark:bg-primary-2 w-full flex items-center justify-center py-8">
      <div class="w-56">
        <img :src="props.currentUser?.avatar" alt="user default" class="rounded-full w-full">
      </div>
    </div>
    <div class="py-4 px-8 space-y-2 text-primary-3 dark:text-secondary-1">
      <p>Your name</p>
